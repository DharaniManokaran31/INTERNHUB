...
const ManageRecruitersPage = () => {
    ...
    const fetchRecruiters = async () => {
        try {
            ...
            const response = await fetch('https://internhub-backend-d879.onrender.com/api/hr/recruiters', {
                headers: { 'Authorization': `Bearer ${token}` }
            });
            const data = await response.json();
    ...
    const handleRevoke = async (id) => {
        ...
        try {
            const token = localStorage.getItem('authToken');
            const response = await fetch(`https://internhub-backend-d879.onrender.com/api/hr/recruiters/${id}/revoke`, {
                method: 'DELETE',
                headers: { 'Authorization': `Bearer ${token}` }
            });
            const data = await response.json();
    ...
    const handleResendInvite = async (id) => {
        try {
            const token = localStorage.getItem('authToken');
            const response = await fetch(`https://internhub-backend-d879.onrender.com/api/hr/recruiters/${id}/resend`, {
                method: 'POST',
                headers: { 'Authorization': `Bearer ${token}` }
            });
            const data = await response.json();
    ...
    const toggleStatus = async (id, currentStatus) => {
        ...
        try {
            ...
            const response = await fetch(`https://internhub-backend-d879.onrender.com/api/hr/recruiters/${id}/${endpoint}`, {
                method: 'PATCH',
                headers: { 'Authorization': `Bearer ${token}` }
            });
