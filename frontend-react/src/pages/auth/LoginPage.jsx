...
const LoginPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // 1. Try student login
      try {
        const studentResponse = await fetch('https://internhub-backend-d879.onrender.com/api/students/login', {
          method: 'POST',
      ...
      if (!data.success) {
        try {
          const recruiterResponse = await fetch('https://internhub-backend-d879.onrender.com/api/recruiters/login', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
            body: JSON.stringify({
              email: formData.email,
      ...
      if (!data.success) {
        try {
          const adminResponse = await fetch('https://internhub-backend-d879.onrender.com/api/admin/login', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
            body: JSON.stringify({
              email: formData.email,
