...
const BrowseInternshipsPage = () => {
  ...
  const fetchInternships = async () => {
    try {
      ...
      const response = await fetch('https://internhub-backend-d879.onrender.com/api/internships', {
        headers: headers
      });
      const data = await response.json();
  ...
  const handleApply = async () => {
    ...
    try {
      ...
      const response = await fetch('https://internhub-backend-d879.onrender.com/api/applications', {
        method: 'POST',
        headers: {
                ...
                <div style={{
                  ...
                  {profileData?.resume?.resumeFile ? (
                    <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', padding: '0.5rem', background: 'white', borderRadius: '8px' }}>
                      ...
                      <a
                        href={`https://internhub-backend-d879.onrender.com${profileData.resume.resumeFile}`}
                        target="_blank"
