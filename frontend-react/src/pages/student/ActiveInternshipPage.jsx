  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        // Fetch progress data
        const progressResponse = await fetch(`https://internhub-backend-d879.onrender.com/api/progress/student`, {
          headers: { 'Authorization': `Bearer ${token}` }
        });
        ...
        const certResponse = await fetch('https://internhub-backend-d879.onrender.com/api/students/issued-certificates', {
          headers: { 'Authorization': `Bearer ${token}` }
        });
