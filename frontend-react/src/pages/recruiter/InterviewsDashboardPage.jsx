...
const InterviewsDashboardPage = () => {
  ...
  const handleScheduleSubmit = async (scheduleData) => {
    try {
      ...
      const response = await fetch(`https://internhub-backend-d879.onrender.com/api/interviews/${selectedInterview._id}/schedule`, {
        method: 'PUT',
        headers: {
  ...
  const handleFeedbackSubmit = async (feedbackData) => {
    try {
      ...
      const response = await fetch(`https://internhub-backend-d879.onrender.com/api/interviews/${selectedInterview._id}/result`, {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${token}`
