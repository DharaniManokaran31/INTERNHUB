...
const ManageInternshipsPage = () => {
  ...
  const fetchInternships = async () => {
    try {
      ...
      const endpoints = [
        'https://internhub-backend-d879.onrender.com/api/internships/recruiter',
        'https://internhub-backend-d879.onrender.com/api/internships/recruiter/mine',
        'https://internhub-backend-d879.onrender.com/api/internships/my-internships',
        'https://internhub-backend-d879.onrender.com/api/recruiters/my-internships'
      ];
  ...
  const fetchInterviewCounts = async (internshipsList) => {
    try {
      ...
      const response = await fetch('https://internhub-backend-d879.onrender.com/api/interviews/recruiter', {
        headers: { 'Authorization': `Bearer ${token}` }
      });
      const data = await response.json();
  ...
  const handleStatusChange = async (internshipId, newStatus) => {
    try {
      ...
      if (newStatus === 'closed') {
        endpoint = `https://internhub-backend-d879.onrender.com/api/internships/${internshipId}/close`;
        method = 'PATCH';
        body = undefined;
      } else {
        endpoint = `https://internhub-backend-d879.onrender.com/api/internships/${internshipId}`;
        method = 'PUT';
  ...
  const confirmDelete = async () => {
    ...
    try {
      ...
      const response = await fetch(`https://internhub-backend-d879.onrender.com/api/internships/${selectedInternship._id}`, {
        method: 'DELETE',
        headers: {
          'Authorization': `Bearer ${token}`
        }
